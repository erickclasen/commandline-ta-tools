...
class Ichimoku():
    ...
    def run(self):
        ...
        ohcl_df = ohcl_df._append(dates_ext_df)
    ...
    def plot_ichi(self,currency_label):
        fig, ax = plt.subplots()    
        ...
        self.pretty_plot(fig, ax,currency_label)
        save_fig(currency_label+"-ichimoku")
        plt.show()

    def plot_bb(self, currency_label):
        fig, ax = plt.subplots()    
        self.plot_candlesticks(fig, ax)
        self.plot_channels(fig, ax)
        #self.plot_ichimoku(fig, ax)
        ...
        self.pretty_plot(fig, ax,currency_label,title='-USD Bollinger Bands Chart: Daily')
        save_fig(currency_label+"-bbands")
        plt.show()

    def plot_long_bb(self, currency_label):
        fig, ax = plt.subplots()    
        self.plot_candlesticks(fig, ax)
        self.plot_channels(fig, ax)
        #self.plot_ichimoku(fig, ax)
        ...
        self.pretty_plot(fig, ax,currency_label,title='-USD LONG Bollinger Bands Chart: Daily')
    ...
    def plot_stops(self, currency_label):
        fig, ax = plt.subplots()    
        self.plot_candlesticks(fig, ax)
        ...
        self.pretty_plot(fig, ax,currency_label,title='-USD Trailing Stoploss and Breakout Channel Chart: Daily')
        save_fig(currency_label+"-stops")
        plt.show()        



    def pretty_plot(self, fig, ax,currency_label,title = '-USD Ichimoku Cloud Chart: Daily'):
        ax.legend()
        fig.autofmt_xdate()
        ax.xaxis_date()

        # Chart info
        #title = 'Ichimoku Cloud Chart (Currency-USD)'
        bgcolor = '#131722'
        grid_color = '#363c4e'
        spines_color = '#d9d9d9'
        # Axes
        plt.title(currency_label+title, color='white')
